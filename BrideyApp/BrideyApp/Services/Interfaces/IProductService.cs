...
namespace BrideyApp.Services.Interfaces
{
    public interface IProductService
    {
        ...
        Task<List<Product>> GetPaginatedDatas(int page,int take,string sortValue,string searchText, int? cateId,int? compositionId, int? sizeId, int? colorId, int? brandId, int? value1, int? value2);
